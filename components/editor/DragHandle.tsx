 ...
 */
export default function DragHandle(props: React.HTMLAttributes<HTMLButtonElement>) {
  return (
    <button
      type="button"
      aria-label="Drag to reorder"
      className="flex h-6 w-5 shrink-0 cursor-grab items-center justify-center rounded text-[var(--color-ink-dim)] hover:text-[var(--color-accent)] active:cursor-grabbing"
      {...props}
    >
