...
| T16 | Quality pass: `warning` colour tokens, drop `forwardRef` for React 19 ref-as-prop, de-duplicate the latex-unavailable response | `app/globals.css`, `components/**`, `lib/latex.ts`, `app/api/resumes/[id]/{render,pdf}` | `feat/t16-quality-pass`    | ✅ done, unmerged |
